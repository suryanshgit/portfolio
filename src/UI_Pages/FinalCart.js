...
import {FinalOrderCart} from '../CartCounter/CartOrderList'
// import { FinalOrderCart } from "../App";

const FinalCart = ({cart,setCart}) => {
  //  const {cart,setCart} =useContext(FinalOrderCart)
  
  //  setCart(JSON.parse(localStorage.getItem("cart"))); 
   console.log("value of cart is ")
   console.log(cart)
